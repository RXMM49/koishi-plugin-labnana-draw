...
exports.LabnanaClient = void 0;
const axios_1 = __importDefault(require("axios"));
const form_data_1 = __importDefault(require("form-data"));
const koishi_1 = require("koishi");
const https_proxy_agent_1 = require("https-proxy-agent");
const logger = new koishi_1.Logger('labnana-draw');
class LabnanaClient {
    config;
    ctx;
    ...
    createAxiosConfig(additionalConfig = {}) {
        ...
        if (this.config.proxyEnabled && this.config.proxyUrl) {
            const proxyAgent = new https_proxy_agent_1.HttpsProxyAgent(this.config.proxyUrl);
    ...
    async textToImage(params) {
        return this.executeWithRetry(async () => {
            try {
                ...
                const response = await axios_1.default.post(`${this.config.baseUrl}/openapi/v1/images/generation`, payload, axiosConfig);
    ...
    async imageToImage(params) {
        return this.executeWithRetry(async () => {
            try {
                ...
                const response = await axios_1.default.post(`${this.config.baseUrl}/openapi/v1/images/image-to-image`, formData, axiosConfig);
    ...
    async validateApiKey() {
        try {
            ...
            const response = await axios_1.default.post(`${this.config.baseUrl}/openapi/v1/images/generations`, {
                prompt: 'test',
                width: 64,
                height: 64,
                steps: 1,
...
exports.LabnanaClient = LabnanaClient;
